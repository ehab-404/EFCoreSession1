...
#region
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //modelBuilder.Entity<Employee>()
            //            .Property(E => E.DateOfCreation).HasDefaultValueSql("GETDATE()");
            ...
            //    // Changed all [modelBuilder.Entity<Employee>()] To [E] 
            //    E.HasKey(E => E.EmpId);
        ...
        // Microsoft.EntityFrameworkCore -> download from ->
        // 1. nuget.org
        // 2. view -> package Manger Console
        //    PM>  cls
        ...
        public AppDbContext() : base() { } // constructor
        ...
        public DbSet<Employee> Employees { get; set; } // Mapping to table Employees
